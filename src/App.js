...
class App extends Component {
  constructor(props) {
    ...
    this.girls = [
      ...
      {
        key: 1,
        picture: "https://1.bp.blogspot.com/_qEbjiFbQWGM/TCBVlN3mkYI/AAAAAAAADCM/7CjYqUHwbgY/s1600/workshop_modell_0126.jpg",
        name: "Matilda",
        age: "19",
      },
      {
        key: 2,
        picture: "https://steemitimages.com/DQmTeyuLCuyPz6Y1rU6YVKEMMkeQeJzUfRaaNxpZdUeY7Hh/Blue%20Eyes%20Hot%20Girls.jpg",
        name: "Victoria",
        age: "23",
      },
      {
      ...
      {
        key: 5,
        picture: "http://3.bp.blogspot.com/-75xAd3IEA34/U7S3580MDbI/AAAAAAAABlo/E4ESkscWI74/s1600/641x750xcute-australia-fans-girls-on-world-cup-2014_1400467729.jpg.pagespeed.ic.idUr3HxG63%5B1%5D.jpg",
        name: "Eliza",
        age: "25",
      },
      {
        ...
        <div className="container">
          ...
          <div className="button-container">
            <Button
              label="×"
              color="red"
              onclick={this.clickNope}
              animeEnd={this.animationEnd}
            />
            <Button
              label="♥"
              color="skyblue"
